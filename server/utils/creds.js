const credTemplate = (category, categoryId, password) => {
  var message = `<html>
                                                  ...
                                                  <tbody>
                                                      <tr>
                                                          <td align="left" valign="middle" width="50%"><span
                                                                  style="font-weight: bold;margin:0;color:#00A8CC;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">SYSTEM
                                                                  ADMIN | REVELS'22</span>
                                                          </td>
                                                                                      ...
                                                                                      <tr>
                                                                                          <td align="center" width="100%"
                                                                                              ...
                                                                                              <p
                                                                                                  ...
                                                                                                  <strong>Category
                                                                                                      ID:</strong>
                                                                                                  ${categoryId}<br /><strong>Password:
                                                                                                  </strong>${password}
                                                                                              </p>
                                                                                              <p
                                                                                                  style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;color: #fff;">
                                                                                                  Please keep the credentials safe and  login at <a style="text-decoration:
                                                                                                  none; color: #fff;
                                                                                                  font-weight: bold;"
                                                                                                      href="https://organizer.revelsmit.in/admin"
                                                                                                      target="_blank">organizer.revelsmit.in/admin</a>
                                                                                              </p>
                                                                                              ...
                                                                                              <p
                                                                                                  ...
                                                                                                  <string>Akash
                                                                                                      Agarwal
                                                                                                      <a style="text-decoration: none; color: #fff; font-weight: bold;"
                                                                                                          href="tel:+91-9810371689">(+91-9810371689)</a>
                                                                                                      <br />
                                                                                                      <strong>System Admin
                                                                                                          & Web
                                                                                                          Dev</strong>
